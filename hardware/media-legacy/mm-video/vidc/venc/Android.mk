...
libmm-venc-inc      += device/huawei/u8951/hardware/media-legacy/mm-core/inc
libmm-venc-inc      += device/huawei/u8951/hardware/media-legacy/libstagefrighthw
libmm-venc-inc      += device/huawei/u8951/hardware/display-legacy/libgralloc
libmm-venc-inc      += frameworks/native/include/media/hardware
libmm-venc-inc      += frameworks/native/include/media/openmax
libmm-venc-inc      += device/huawei/u8951/hardware/media-legacy/libc2dcolorconvert
libmm-venc-inc      += device/huawei/u8951/hardware/display-legacy/libcopybit
...
mm-venc-test720p-inc            += device/huawei/u8951/hardware/media-legacy/mm-core/inc
mm-venc-test720p-inc            += device/huawei/u8951/hardware/display-legacy/libgralloc
...
LOCAL_C_INCLUDES                += device/huawei/u8951/hardware/media-legacy/mm-core/inc
ifneq ($(TARGET_KERNEL_SOURCE),)
LOCAL_ADDITIONAL_DEPENDENCIES   := $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/usr
endif
LOCAL_PRELINK_MODULE            := false
